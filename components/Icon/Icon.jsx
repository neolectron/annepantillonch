...
const Facebook = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 155.139 155.139" {...props}>
    <path fill="currentColor" 
...
const Icon = ({name, ...rest}) => (
  <>
    { name === 'youtube' && <Youtube {...rest} />}
    { name === 'facebook' && <Facebook {...rest} /> }
    { name === 'linkedin' && <Linkedin {...rest} />}
    { name === 'instagram' && <Instagram {...rest} />}
  </>
);
