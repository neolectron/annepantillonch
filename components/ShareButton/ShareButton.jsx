...
const ShareButton = ({title}) => {
  ...
  return (
    ...
    item ? 
      <a.div key={key} style={props} onClick={() => setOpen(false)}>
    ...
    :
      <a.svg key={key} style={props} onClick={() => setOpen(true)} height="24" width="24" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
